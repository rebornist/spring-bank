...
public class JwtAuthorizationFilterTest {
    ...
    public void authorization_success_test() throws Exception {
        ...
        // when
        ResultActions result = mvc.perform(get("/api/s/hello/test").header(JwtVo.HEADER, jwtToken));
    ...
    public void authorization_admin_test() throws Exception {
        ...
        // when
        ResultActions result = mvc.perform(get("/api/admin/hello/test").header(JwtVo.HEADER, jwtToken));
